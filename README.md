...
小说改编剧本时，作者通常需要整理章节、人物、地点、场景、画面、动作、对白、音效、情绪语气和转场。Novel2Script 将这个流程拆成清晰的产品链路：
...
3. 确认检测到 3 个章节以上。
4. 点击“生成可修改剧本”。
5. 在中文剧本修改页修改标题、梗概、人物、地点和每一场的连续场景正文；需要时可展开结构化字段查看或调整画面、动作、台词、音效、场景摘要、节拍与转场。
6. 点击“生成 YAML”。
7. 校验 YAML。
8. 校验通过后导出 YAML。
...
- [PR #4 Refine continuous scene editor](https://github.com/maybebebee/Novel2Script/pull/4)
