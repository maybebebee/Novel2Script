...
- scenes[].summary 是场景摘要，应概括本场的剧情功能和情绪转折，不要堆叠具体动作细节
...
- dialogues[].emotion 用于记录该句台词的说话情绪，例如“震惊”“愧疚”“压抑”“恐惧”
- screenplay_text 必须是面向剧作家阅读的完整中文剧本正文，包含场面描写、动作、对白、音效、情绪和转场，不少于 120 个中文字符
- screenplay_text 必须使用清晰换行结构：第一行写“第N场 地点 时间”，之后用空行分隔氛围、动作、对白、关键发现和转场
- screenplay_text 中对白使用“角色：台词”或“角色（情绪）：台词”的格式；转场单独一行，使用“转场：...”格式
- screenplay_text 应该尽量接近这种阅读格式：
  第3场 灯塔 夜

  冷冽，海风刺骨，灯塔外的石阶被潮气打湿。

  顾眠带着林澈沿石阶往上走。她从项链上取下钥匙，插进锈蚀的铁门。
